...
def page_home(): 
    ...
    st.markdown("<h1 style='text-align: center; font-size: 2em; font-weight: bold;'>Welcome to LoanEasy</h1>", unsafe_allow_html=True) # Display the DataFrame below the welcome message 
